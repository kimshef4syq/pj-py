...
extern GainType bkoptm_BestG2;

extern Node **bkdt_KDTree;
extern int bkdt_cutoff;

extern Node **cqcs_KDTree;
extern Candidate *cqcs_CandidateSet;
extern double *cqcs_XMin, *cqcs_XMax, *cqcs_YMin, *cqcs_YMax, *cqcs_ZMin,
    *cqcs_ZMax;
extern int cqcs_Candidates, cqcs_Radius;
extern int cqcs_Level;

extern Node *erxt_FirstFree;
extern int erxt_Tabu;

extern Node *gain23_s1;
extern short gain23_OldReversed;

extern int grdt_EdgesInFragments;
extern GainType grdt_Cost;

extern int heap_HeapCount;
extern int heap_HeapCapacity;

extern int pc_CurrentCycle;
extern int pc_Patchwork;
extern int pc_RecLevel;

extern Node *seq_tp1;

extern Node **sksp_KDTree;
extern GainType sksp_GlobalBestCost, sksp_OldGlobalBestCost;
extern int sksp_CurrentSubproblem, sksp_Subproblems;

extern int srsp_Size;
extern Node **srsp_KDTree;

extern int stat_TrialsMin, stat_TrialsMax, stat_TrialSum, stat_Successes;
extern GainType stat_CostMin, stat_CostMax, stat_CostSum;
extern double stat_TimeMin, stat_TimeMax, stat_TimeSum;
...
extern int
    MaxMatrixDimension; /* Maximum dimension for an explicit cost matrix */
...
extern char *Name, *Type, *EdgeWeightType, *EdgeWeightFormat, *EdgeDataFormat,
    *NodeCoordType, *DisplayDataType;
extern int CandidateSetSymmetric, CandidateSetType, CoordType,
    DelaunayPartitioning, DelaunayPure, ExtraCandidateSetSymmetric,
    ExtraCandidateSetType, InitialTourAlgorithm, KarpPartitioning,
    KCenterPartitioning, KMeansPartitioning, MoorePartitioning,
    PatchingAExtended, PatchingARestricted, PatchingCExtended,
    PatchingCRestricted, ProblemType, RohePartitioning, SierpinskiPartitioning,
    SubproblemBorders, SubproblemsCompressed, WeightType, WeightFormat;

extern FILE *ParameterFile, *ProblemFile, *PiFile, *InputTourFile, *TourFile,
...
void Make3OptMove(Node *t1, Node *t2, Node *t3, Node *t4, Node *t5, Node *t6,
                  int Case);
void Make4OptMove(Node *t1, Node *t2, Node *t3, Node *t4, Node *t5, Node *t6,
                  Node *t7, Node *t8, int Case);
void Make5OptMove(Node *t1, Node *t2, Node *t3, Node *t4, Node *t5, Node *t6,
                  Node *t7, Node *t8, Node *t9, Node *t10, int Case);
