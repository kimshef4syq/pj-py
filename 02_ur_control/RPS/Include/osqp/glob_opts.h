...
// functions are thread-safe, the GIL does not need to be held. The default raw
// memory allocator uses the following functions: malloc(), calloc(), realloc()
// and free(); call malloc(1) (or calloc(1, 1)) when requesting zero bytes.
